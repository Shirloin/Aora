        ...
        <SafeAreaView className='bg-primary h-full '>
            <ScrollView className='px-4 my-6'>
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity>
                        {form.video ? (
                            <Video source={{ uri: form.video }} className='w-full h-64 rounded-2xl' useNativeControls resizeMode={ResizeMode.COVER} isLooping />
                        ) : (
                ...
                <View className='mt-7 space-y-2'>
                    ...
                    <TouchableOpacity>
                        {form.thumbnail ? (
                            <Image source={{ uri: form.thumbnail }} className='w-full h-64 rounded-2xl' resizeMode={ResizeMode.COVER} />
                        ) : (
